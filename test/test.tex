...
\input{../output/0-table-summary.tex}

% \begin{table*}
%     \caption{UCI benchmarks. Each square shows the performance of a given model (rows) on a given dataset (columns). The intensity of the colouring represents the certitude that the associated model performed best on the given dataset. Grey rows mean impossible evaluation for a metric.}
%     \vspace{3mm}
%     \label{tab:uci}
% \end{table*}
